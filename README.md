...
A single-page web application that generates random website themes (color palettes + font pairings) and provides ready-to-use JSON and LLM prompts.
...
## Credits
Created by [AlexMerced](https://alexmerced.com).
